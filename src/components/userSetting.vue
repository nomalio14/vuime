                          ...
                          <v-expansion-panel class="expansion" v-model="panel">
                            <v-expansion-panel-content class="expansionHeader">
                              <template v-slot:header>
                                <div class="expansionText">
                                  <v-icon>https</v-icon>Change the password
                                </div>
                              </template>
                              <v-text-field
...
export default {
  ...
  validations: {
    newUserInfo: { name: { required }, email: { email, required } },
  ...
  computed: {
    ...
    nameErrors() {
      ...
      !this.$v.newUserInfo.name.required &&
    ...
    emailErrors() {
      ...
      !this.$v.newUserInfo.email.email &&
        errors.push('Correct address is required.')
      !this.$v.newUserInfo.email.required &&
        errors.push('This field is required.')
      return errors
    },
    newPasswordErrors() {
